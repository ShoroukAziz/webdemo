...
import com.isfp.app.ws.io.repositories.AddressRepository;
...
public class AddressServiceImpl implements  AddressService{
	...
	public AddressDto getAddress(String addressId) {
		...
		AddressDto returnValue = addressEntity != null ?  new ModelMapper().map(addressEntity, AddressDto.class):  null;
